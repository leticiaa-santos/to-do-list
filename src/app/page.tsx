      ...
      <Card className="w-lg">
        ...
        <CardContent>
          ...
          <div className="flex gap-2">
            ...
            <Badge className="cursor-pointer" variant="outline"><OctagonX />Não finalizadas</Badge>
          ...
          <div className="flex justify-between mt-4">
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button className="text-xs h-8 cursor-pointer" variant="outline"><Trash />Limpar tarefas concluídas</Button>
              </AlertDialogTrigger>
              <AlertDialogContent>
                <AlertDialogHeader>
